...
The following commands document the main training and evaluation workflows.
...
python src/evaluate_new_experiment.py unet_open --data-root <data_root> --run-dir <run_dir>
```
...
python src/evaluate_new_experiment.py unet_forward --data-root <data_root> --run-dir <run_dir>
...
python src/evaluate_new_experiment.py unet_closed --data-root <data_root> --run-dir <run_dir>
```
...
python src/evaluate_wa_closed_loop.py --data-root <data_root> --run-dir <run_dir>
```
...
python src/evaluate_new_experiment.py multi_forward --data-root <data_root> --run-dir <run_dir>

python src/train_multi_closed_loop_lnn.py inverse --data-root <data_root> --work-dir <run_dir>
python src/evaluate_new_experiment.py multi_inverse --data-root <data_root> --run-dir <run_dir>
```
